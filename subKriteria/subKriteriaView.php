                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select class="form-select d-inline" name="subkriBobot">
                                    <option value="0.25" <?php if ($subkriteria['subkriteria_bobot'] == '0.25') {
                                                                echo "selected";
                                                            } ?>>0.25</option>
                                    <option value="0.5" <?php if ($subkriteria['subkriteria_bobot'] == '0.5') {
                                                            echo "selected";
                                                        } ?>>0.5</option>
                                    <option value="0.75" <?php if ($subkriteria['subkriteria_bobot'] == '0.75') {
                                                                echo "selected";
                                                            } ?>>0.75</option>
